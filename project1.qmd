...
<p>
Para simplificar essa tarefa, surgiu o LangChain <https://www.langchain.com/>, uma estrutura de código aberto que facilita o desenvolvimento de aplicativos com LLMs. O LangChain atua como uma interface genérica para diferentes LLMs, permitindo a construção de aplicativos LLM integrados a fontes de dados externas. Este projeto visa demonstrar a aplicação prática do ChatGPT em um contexto específico com o auxílio do LangChain, explorando cada etapa e os principais desafios envolvidos.
</p>
...
Os modelos de linguagem têm um limite de tokens que não podemos exceder. Portanto, essa divisão será feita considerando um número máximo de tokens por documento. Embora o texto seja dividido por caracteres, o tamanho do segmento é medido em termos de tokens.

É importante ressaltar que o tokenizador que utilizaremos deve ser o mesmo utilizado dentro do LLM principal, que neste caso é o ChatGPT. Isso garante que estejamos contando tokens da mesma forma em ambas as etapas.
...
class AskAboutContext:
    ...
    def __tokenization(self):
        text_splitter = RecursiveCharacterTextSplitter.from_tiktoken_encoder(
            ...
            chunk_size    = 512, # Quantidade máxima de tokens por split
            chunk_overlap = 24,  # Quantidade de caracteres sobrepostos por split
        )
